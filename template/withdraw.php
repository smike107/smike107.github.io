<html lang="en"><head>
		...
		<title>Withdraw - y91036d3.beget.tech</title>
		...
		<script type="text/javascript" src="http://y91036d3.beget.tech/template/js/offers.js?v=106"></script>
		<script>
...
<div class="alert alert-danger text-center">
  <b><i class="fa fa-exclamation-triangle"></i>  If you will cancel trade offer, the coins won't be credited!</b>
</div>
				

<div id="inlineAlert" class="alert alert-danger" style="font-weight:bold"><i class="fa fa-check"></i><b> Loading items...</b></div>
				...
				<div class="panel panel-default text-left fw-4" style="vertical-align:top">
					<div class="panel-heading">
						<center><h3 class="panel-title"><b>Coins: <span id="sum">0</span> | Balance : <span id="avail">0</span> | Available: <span id="manmanavail">0</span></b></h3></center>
					</div>
					<div class="panel-body">
